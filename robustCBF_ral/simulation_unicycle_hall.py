...
from safety_filterRAL_implicitH_hall_4sim import SSF, get_h0
...
gamma1_values = np.array(gamma1_values)  # Shape (timesteps,)
gamma2_values = np.array(gamma2_values)  # Shape (timesteps,)

u_nom_uni1_values = np.array(u_nom_uni1_values)  # Shape (timesteps,)
u_nom_uni2_values = np.array(u_nom_uni2_values)  # Shape (timesteps,)
