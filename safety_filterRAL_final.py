...
class SSF:
    ...
    def __init__(
        ...
        self.c = 3 * np.pi / 6 # frequency parameter for the narrow passage
    ...
    def control_ssf(self, state, u_nominal, phi, psi, theta, dot_phi, dot_theta, dot_psi, ddot_psi, ddot_theta,
        ...
        rho      = -Lf_h - alpha_hs + gammas1_flat*g_norm + gammas2_flat*g_norm**2
        ...
        def rob_term(k1, k2, Lg_vec, h_val):
            ...
            return k1 * nrm * w + (k2 **2 ) * (nrm**2) * w # we use gamma_2^2 as in the paper
        ...
        self.data_dict = {
            "uncertainty_data_1": self.k_1,
            "uncertainty_data_2": self.k_2,
            "uncertainty_data_3": delta,
